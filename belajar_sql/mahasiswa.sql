...
insert into jurusan (kode,nama) values ('APNL','Manajemen');

-- masukin data mahasiswa
insert into mahasiswa (id_jurusan, nim, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat)
values (1,'20220001', 'apri', 'laki-laki', 'P. Berandan', '2001-05-15', 'Jl. P. Berandan');
insert into mahasiswa (id_jurusan, nim, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat)
values (2,'20220002', 'ApriAldi', 'laki-laki', 'P. Berandan', '2001-04-15', 'Jl. Pelawi');
